...
\usepackage{pdfpages}
\usepackage{newfloat}
\DeclareFloatingEnvironment[placement={!ht},name=Algorytm]{alg}
\DeclareFloatingEnvironment[placement={!ht},name=Komunikat JSON]{json}
...
& Dodano sekcję Strategie AI. Dodano więcej przykładowych komunikatów. Uzupełniono wymagania niefunkcjonalne o wpis o testach.
& 2.2                                              
\\ \hline
Jan 21, 2017
& Sebastian Jakubiak, Mikołaj Karaś, Tomasz Koter 
& Poprawiono diagramy, architekturę rozwiązania. Dodano opis prowadzenia wielu rozgrywek za pośrednictwem jednego serwera. Dodano opis podziału na aplikacje.
& 2.1
\\ \hline
Jan 16, 2017
& Sebastian Jakubiak, Mikołaj Karaś, Tomasz Koter 
...
\\ \cline{2-3}
& 8
& Przetestowane zostaną fragmenty kodu dotyczące nawiązywania połączeń oraz przesyłania komunikatów.
\\ \hline
\end{tabular}
}
\end{table}
